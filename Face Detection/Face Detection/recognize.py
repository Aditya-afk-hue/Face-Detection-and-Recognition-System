...
classifier = cv2.CascadeClassifier(r"C:/Users/HP/OneDrive/Desktop/Face Detection/Face Detection/haarcascade_frontalface_default.xml")

model = load_model(r"C:/Users/HP/OneDrive/Desktop/Face Detection/Face Detection/final_model.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['aditya', 'images']
    return labels[pred]
